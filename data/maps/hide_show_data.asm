...
Route2HS:
	...
	db ROUTE_2, ROUTE2_HP_UP,      HIDE
Route4HS:
	db ROUTE_4, ROUTE4_TM_WHIRLWIND, SHOW
Route9HS:
	db ROUTE_9, ROUTE9_TM_TELEPORT, HIDE
	db ROUTE_9, ROUTE9_SURGE_HUBBY, SHOW
Route12HS:
	db ROUTE_12, ROUTE12_SNORLAX,    SHOW
	db ROUTE_12, ROUTE12_IRON,       HIDE
Route15HS:
Route16HS:
...
CeruleanCaveHS:
	db CERULEAN_CAVE_1F, CERULEANCAVE1F_FULL_RESTORE, HIDE
	db CERULEAN_CAVE_1F, CERULEANCAVE1F_MAX_ELIXER,   HIDE
	db CERULEAN_CAVE_1F, CERULEANCAVE1F_NUGGET,       SHOW
PokemonTower2FHS:
	db POKEMON_TOWER_2F, POKEMONTOWER2F_RIVAL, SHOW
PokemonTower3FHS:
	db POKEMON_TOWER_3F, POKEMONTOWER3F_ESCAPE_ROPE, HIDE
PokemonTower4FHS:
	db POKEMON_TOWER_4F, POKEMONTOWER4F_ELIXER,    HIDE
	db POKEMON_TOWER_4F, POKEMONTOWER4F_AWAKENING, HIDE
	db POKEMON_TOWER_4F, POKEMONTOWER4F_HP_UP,     HIDE
PokemonTower5FHS:
	db POKEMON_TOWER_5F, POKEMONTOWER5F_NUGGET, SHOW
PokemonTower6FHS:
	db POKEMON_TOWER_6F, POKEMONTOWER6F_RARE_CANDY, SHOW
	db POKEMON_TOWER_6F, POKEMONTOWER6F_X_ACCURACY, HIDE
PokemonTower7FHS:
...
PokemonMansion1FHS:
	db POKEMON_MANSION_1F, POKEMONMANSION1F_ESCAPE_ROPE, HIDE
	db POKEMON_MANSION_1F, POKEMONMANSION1F_CARBOS,      HIDE
FightingDojoHS:
...
PowerPlantHS:
	...
	db POWER_PLANT, POWERPLANT_CARBOS,     HIDE
	db POWER_PLANT, POWERPLANT_HP_UP,      HIDE
...
VictoryRoad2FHS:
	...
	db VICTORY_ROAD_2F, VICTORYROAD2F_FULL_HEAL,     HIDE
	db VICTORY_ROAD_2F, VICTORYROAD2F_TM_MEGA_KICK,  HIDE
	db VICTORY_ROAD_2F, VICTORYROAD2F_GUARD_SPEC,    HIDE
...
ViridianForestHS:
	db VIRIDIAN_FOREST, VIRIDIANFOREST_ANTIDOTE,  HIDE
	db VIRIDIAN_FOREST, VIRIDIANFOREST_POTION,    HIDE
	db VIRIDIAN_FOREST, VIRIDIANFOREST_POKE_BALL, SHOW
MtMoon1FHS:
	db MT_MOON_1F, MTMOON1F_POTION1,      HIDE
	db MT_MOON_1F, MTMOON1F_MOON_STONE,   SHOW
	db MT_MOON_1F, MTMOON1F_RARE_CANDY,   SHOW
	db MT_MOON_1F, MTMOON1F_ESCAPE_ROPE,  HIDE
	db MT_MOON_1F, MTMOON1F_POTION2,      HIDE
...
MtMoonB2FHS:
	...
	db MT_MOON_B2F, MTMOONB2F_HP_UP,         HIDE
	db MT_MOON_B2F, MTMOONB2F_TM_MEGA_PUNCH, SHOW
SSAnne2FHS:
	db SS_ANNE_2F, SSANNE2F_RIVAL, HIDE
SSAnne1FRoomsHS:
	db SS_ANNE_1F_ROOMS, SSANNE1FROOMS_TM_BODY_SLAM, HIDE
SSAnne2FRoomsHS:
	db SS_ANNE_2F_ROOMS, SSANNE2FROOMS_MAX_ETHER,  HIDE
	db SS_ANNE_2F_ROOMS, SSANNE2FROOMS_RARE_CANDY, SHOW
SSAnneB1FRoomsHS:
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_ETHER,      HIDE
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_TM_REST,    SHOW
	db SS_ANNE_B1F_ROOMS, SSANNEB1FROOMS_MAX_POTION, HIDE
VictoryRoad3FHS:
	db VICTORY_ROAD_3F, VICTORYROAD3F_MAX_REVIVE,   HIDE
	db VICTORY_ROAD_3F, VICTORYROAD3F_TM_EXPLOSION, HIDE
	db VICTORY_ROAD_3F, VICTORYROAD3F_BOULDER4,     SHOW
RocketHideoutB1FHS:
	db ROCKET_HIDEOUT_B1F, ROCKETHIDEOUTB1F_ESCAPE_ROPE,  HIDE
	db ROCKET_HIDEOUT_B1F, ROCKETHIDEOUTB1F_HYPER_POTION, HIDE
RocketHideoutB2FHS:
	...
	db ROCKET_HIDEOUT_B2F, ROCKETHIDEOUTB2F_SUPER_POTION,  HIDE
RocketHideoutB3FHS:
	db ROCKET_HIDEOUT_B3F, ROCKETHIDEOUTB3F_TM_DOUBLE_EDGE, HIDE
	db ROCKET_HIDEOUT_B3F, ROCKETHIDEOUTB3F_RARE_CANDY,     SHOW
RocketHideoutB4FHS:
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_GIOVANNI,      SHOW
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_HP_UP,         HIDE
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_TM_RAZOR_WIND, SHOW
	db ROCKET_HIDEOUT_B4F, ROCKETHIDEOUTB4F_IRON,          HIDE
...
SilphCo3FHS:
	...
	db SILPH_CO_3F, SILPHCO3F_HYPER_POTION, HIDE
SilphCo4FHS:
	db SILPH_CO_4F, SILPHCO4F_ROCKET1,     SHOW
	db SILPH_CO_4F, SILPHCO4F_SCIENTIST,   SHOW
	db SILPH_CO_4F, SILPHCO4F_ROCKET2,     SHOW
	db SILPH_CO_4F, SILPHCO4F_FULL_HEAL,   HIDE
	db SILPH_CO_4F, SILPHCO4F_MAX_REVIVE,  HIDE
	db SILPH_CO_4F, SILPHCO4F_ESCAPE_ROPE, HIDE
SilphCo5FHS:
	...
	db SILPH_CO_5F, SILPHCO5F_PROTEIN,      HIDE
...
SilphCo6FHS:
	...
	db SILPH_CO_6F, SILPHCO6F_HP_UP,      HIDE
	db SILPH_CO_6F, SILPHCO6F_X_ACCURACY, HIDE
SilphCo7FHS:
	...
	db SILPH_CO_7F, SILPHCO7F_CALCIUM,         HIDE
...
SilphCo9FHS:
	...
	db SILPH_CO_9F, SILPHCO9F_NURSE,     SHOW
SilphCo10FHS:
	...
	db SILPH_CO_10F, SILPHCO10F_TM_EARTHQUAKE,  HIDE
	db SILPH_CO_10F, SILPHCO10F_RARE_CANDY,     SHOW
	db SILPH_CO_10F, SILPHCO10F_CARBOS,         HIDE
SilphCo11FHS:
...
PokemonMansion2FHS:
	db POKEMON_MANSION_2F, POKEMONMANSION2F_CALCIUM, HIDE
PokemonMansion3FHS:
	db POKEMON_MANSION_3F, POKEMONMANSION3F_MAX_POTION, HIDE
	db POKEMON_MANSION_3F, POKEMONMANSION3F_IRON,       HIDE
PokemonMansionB1FHS:
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_RARE_CANDY,   SHOW
	db POKEMON_MANSION_B1F, POKEMONMANSIONB1F_FULL_RESTORE, HIDE
...
SafariZoneEastHS:
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_FULL_RESTORE, HIDE
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_MAX_RESTORE,  SHOW
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_CARBOS,       HIDE
	db SAFARI_ZONE_EAST, SAFARIZONEEAST_TM_EGG_BOMB,  SHOW
SafariZoneNorthHS:
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_PROTEIN,       HIDE
	db SAFARI_ZONE_NORTH, SAFARIZONENORTH_TM_SKULL_BASH, SHOW
SafariZoneWestHS:
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_MAX_POTION,     HIDE
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_TM_DOUBLE_TEAM, SHOW
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_MAX_REVIVE,     HIDE
	db SAFARI_ZONE_WEST, SAFARIZONEWEST_GOLD_TEETH,     SHOW
SafariZoneCenterHS:
	db SAFARI_ZONE_CENTER, SAFARIZONECENTER_NUGGET, SHOW
CeruleanCave2FHS:
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_PP_UP,        HIDE
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_ULTRA_BALL,   SHOW
	db CERULEAN_CAVE_2F, CERULEANCAVE2F_FULL_RESTORE, HIDE
CeruleanCaveB1FHS:
	db CERULEAN_CAVE_B1F, CERULEANCAVEB1F_MEWTWO,     HIDE
