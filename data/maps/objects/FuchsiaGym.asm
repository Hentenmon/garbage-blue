...
FuchsiaGym_Object:
	...
	object_event  8, 12, SPRITE_ROCKER, STAY, RIGHT, TEXT_FUCHSIAGYM_ROCKER1, OPP_JUGGLER, 7
	object_event  7,  8, SPRITE_ROCKER, STAY, RIGHT, TEXT_FUCHSIAGYM_ROCKER2, OPP_JUGGLER, 3
	object_event  9, 10, SPRITE_ROCKER, STAY, LEFT, TEXT_FUCHSIAGYM_ROCKER3, OPP_JUGGLER, 8
	object_event  3,  5, SPRITE_ROCKER, STAY, LEFT, TEXT_FUCHSIAGYM_ROCKER4, OPP_TAMER, 1
	object_event  8,  2, SPRITE_ROCKER, STAY, UP, TEXT_FUCHSIAGYM_ROCKER5, OPP_TAMER, 2
