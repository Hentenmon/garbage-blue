...
PokemonMansion3F_Object:
	...
	warp_event 5,  13, VIRIDIAN_CITY, 1

	def_bg_events

	def_object_events
	object_event  6,  2, SPRITE_SUPER_NERD, STAY, UP, TEXT_POKEMONMANSION3F_SUPER_NERD, OPP_BURGLAR, 8
	object_event 18, 11, SPRITE_SCIENTIST, STAY, LEFT, TEXT_POKEMONMANSION3F_SCIENTIST, OPP_SCIENTIST, 12
	object_event  1, 16, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSION3F_MAX_POTION, RARE_CANDY
