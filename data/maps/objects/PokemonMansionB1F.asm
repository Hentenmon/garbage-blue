...
PokemonMansionB1F_Object:
	...
	def_object_events
	object_event 23, 23, SPRITE_SUPER_NERD, STAY, UP, TEXT_POKEMONMANSIONB1F_BURGLAR, OPP_BURGLAR, 9
	object_event 13,  4, SPRITE_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSIONB1F_SCIENTIST, OPP_SCIENTIST, 13
	object_event 10,  2, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_RARE_CANDY, RARE_CANDY
	object_event  1, 22, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_FULL_RESTORE, RARE_CANDY
	object_event 19, 25, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_BLIZZARD, TM_BUBBLEBEAM
	object_event  5,  4, SPRITE_POKE_BALL, STAY, NONE, TEXT_POKEMONMANSIONB1F_TM_SOLARBEAM, TM_MEGA_DRAIN
