...
Route10_Object:
	...
	def_object_events
	object_event 14, 43, SPRITE_SUPER_NERD, STAY, DOWN, TEXT_ROUTE10_SUPER_NERD1, OPP_POKEMANIAC, 1
	object_event  5, 56, SPRITE_HIKER, STAY, UP, TEXT_ROUTE10_HIKER1, OPP_HIKER, 7
	object_event 12, 65, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_ROUTE10_SUPER_NERD2, OPP_POKEMANIAC, 2
	object_event  4, 20, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE10_COOLTRAINER_F1, OPP_JR_TRAINER_F, 7
