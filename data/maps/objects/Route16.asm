...
Route16_Object:
	...
	bg_event  3, 13, TEXT_ROUTE16_SIGN

	def_object_events
	object_event  2, 12, SPRITE_BIKER, STAY, UP, TEXT_ROUTE16_BIKER1, OPP_BIKER, 5
	object_event  3, 12, SPRITE_BIKER, STAY, UP, TEXT_ROUTE16_BIKER2, OPP_CUE_BALL, 1
	object_event 17, 13, SPRITE_BIKER, STAY, UP, TEXT_ROUTE16_BIKER3, OPP_CUE_BALL, 2
	object_event 12, 11, SPRITE_BIKER, STAY, UP, TEXT_ROUTE16_BIKER4, OPP_BIKER, 6
	object_event  2, 13, SPRITE_BIKER, STAY, LEFT, TEXT_ROUTE16_BIKER5, OPP_CUE_BALL, 3
	object_event  6, 11, SPRITE_BIKER, STAY, UP, TEXT_ROUTE16_BIKER6, OPP_BIKER, 7
