...
Route18_Object:
	...
	def_object_events
	object_event 15,  9, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE18_COOLTRAINER_M1, OPP_BIRD_KEEPER, 8
	object_event 16,  9, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE18_COOLTRAINER_M2, OPP_BIRD_KEEPER, 9
	object_event 17,  9, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE18_COOLTRAINER_M3, OPP_BIRD_KEEPER, 10
