...
Route3_Object:
	...
	object_event 15,  4, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_ROUTE3_YOUNGSTER2, OPP_YOUNGSTER, 1
	object_event 12,  6, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE3_COOLTRAINER_F1, OPP_LASS, 1
	object_event 33,  8, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_ROUTE3_YOUNGSTER3, OPP_BUG_CATCHER, 5
	object_event 49,  6, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE3_COOLTRAINER_F2, OPP_LASS, 2
	object_event 15,  6, SPRITE_YOUNGSTER, STAY, UP, TEXT_ROUTE3_YOUNGSTER4, OPP_YOUNGSTER, 2
	object_event 47,  6, SPRITE_YOUNGSTER, STAY, RIGHT, TEXT_ROUTE3_YOUNGSTER5, OPP_BUG_CATCHER, 6
