...
Route3_Object:
	...
	object_event 29,  8, SPRITE_YOUNGSTER, STAY, DOWN, TEXT_ROUTE3_YOUNGSTER3, OPP_BUG_CATCHER, 5
	object_event 34,  6, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_ROUTE3_COOLTRAINER_F2, OPP_LASS, 2
	object_event 38,  5, SPRITE_YOUNGSTER, STAY, LEFT, TEXT_ROUTE3_YOUNGSTER4, OPP_YOUNGSTER, 2
