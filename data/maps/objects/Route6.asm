...
Route6_Object:
	...
	def_object_events
	object_event  4, 17, SPRITE_COOLTRAINER_M, STAY, RIGHT, TEXT_ROUTE6_COOLTRAINER_M1, OPP_JR_TRAINER_M, 4
	object_event  5, 19, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE6_COOLTRAINER_F1, OPP_JR_TRAINER_F, 2
	object_event 15, 18, SPRITE_YOUNGSTER, STAY, UP, TEXT_ROUTE6_YOUNGSTER1, OPP_BUG_CATCHER, 10
