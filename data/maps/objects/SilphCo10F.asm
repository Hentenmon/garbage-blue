...
SilphCo10F_Object:
	...
	def_object_events
	object_event  9,  1, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO10F_ROCKET, OPP_ROCKET, 39
	object_event 10,  2, SPRITE_SCIENTIST, STAY, UP, TEXT_SILPHCO10F_SCIENTIST, OPP_SCIENTIST, 11
	object_event  9, 15, SPRITE_SILPH_WORKER_F, WALK, ANY_DIR, TEXT_SILPHCO10F_SILPH_WORKER_F
	object_event  2, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO10F_TM_EARTHQUAKE, TM_DREAM_EATER
