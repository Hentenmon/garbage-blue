...
SilphCo3F_Object:
	...
	warp_event 20,  0, SILPH_CO_4F, 1
	warp_event 22,  9, SILPH_CO_ELEVATOR, 1
	...
	object_event 27,  1, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO3F_ROCKET, OPP_ROCKET, 25
	object_event 25,  1, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO3F_SCIENTIST, OPP_SCIENTIST, 4
	object_event  8,  5, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO3F_HYPER_POTION, RARE_CANDY
