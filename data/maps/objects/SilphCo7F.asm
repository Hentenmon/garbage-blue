...
SilphCo7F_Object:
	...
	object_event 16,  2, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET1, OPP_ROCKET, 32
	object_event 13,  2, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO7F_SCIENTIST, OPP_SCIENTIST, 8
	object_event 18,  3, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO7F_ROCKET2, OPP_ROCKET, 33
	object_event 14,  2, SPRITE_ROCKET, STAY, DOWN, TEXT_SILPHCO7F_ROCKET3, OPP_ROCKET, 34
	...
	object_event 24, 11, SPRITE_POKE_BALL, STAY, NONE, TEXT_SILPHCO7F_TM_SWORDS_DANCE, TM_SUBMISSION
