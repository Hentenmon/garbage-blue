...
VictoryRoad1F_Object:
	...
	def_warp_events
	warp_event  0, 17, LAST_MAP, 3
	warp_event 19, 17, LAST_MAP, 3
	...
	object_event  8,  6, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_VICTORYROAD1F_COOLTRAINER_M, OPP_COOLTRAINER_M, 5
